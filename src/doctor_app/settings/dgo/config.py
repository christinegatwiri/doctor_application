...
DEFAULT_FILE_STORAGE = "test_proj.settings.dgo.utils.MediaRootS3BotoStorage"

STATICFILES_STORAGE = "test_proj.settings.dgo.utils.StaticRootS3BotoStorage"
...
PRIVATE_FILE_STORAGE = "test_proj.settings.dgo.utils.MediaRootS3BotoStorage"
